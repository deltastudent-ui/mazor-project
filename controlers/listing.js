...
module.exports.renderNewForm =  (req,res)=>{
  ...
  module.exports.postRoutes=   async(req,res, next)=>{
      ...
      module.exports.showRoutes = async (req, res)=>{
        let {id} = req.params;
        const findData = await Listing.findById(id).populate({path:"reviews",populate:{path:"auther"},}) .populate("owner"); // reviews mean listing ka schema hai reviews k liye ye popolate karna pada
